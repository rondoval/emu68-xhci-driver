...
#define USB_PORT_FEAT_ENABLE 1	/* USB 2.0 only */
#define USB_PORT_FEAT_SUSPEND 2 /* USB 2.0 only */
#define USB_PORT_FEAT_OVER_CURRENT 3
#define USB_PORT_FEAT_RESET 4
#define USB_PORT_FEAT_LINK_STATE 5 /* USB 3.0 only */
#define USB_PORT_FEAT_POWER 8
#define USB_PORT_FEAT_LOWSPEED 9   /* USB 2.0 only */
#define USB_PORT_FEAT_HIGHSPEED 10 /* USB 2.0 only */
#define USB_PORT_FEAT_C_CONNECTION 16
#define USB_PORT_FEAT_C_ENABLE 17  /* USB 2.0 only */
#define USB_PORT_FEAT_C_SUSPEND 18 /* USB 2.0 only */
...
#define USB_SS_PORT_FEAT_FORCE_LINKPM_ACCEPT 30
